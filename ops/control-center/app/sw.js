...
const CACHE = "robom-company-os-v6.1.0";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js", "./version.json", "./office.html", "./office.js", "./office-map.json", "./manifest.webmanifest", "./icon.svg", "./assets/fonts/PretendardVariable.woff2", "./assets/fonts/NanumMyeongjo-400.woff2", "./assets/fonts/NanumMyeongjo-700.woff2"];
