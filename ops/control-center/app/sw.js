...
const CACHE = "robom-company-os-v3.2.0";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js", "./version.json", "./office.html", "./office.js", "./office-map.json", "./manifest.webmanifest", "./icon.svg"];
