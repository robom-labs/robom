...
- Android 소스 설정: versionCode 24, `0.17.1`. Play Console과 테스트 트랙은 이번 웹·장부 동기화에서 변경하지 않았다.
...
- [x] Android 0.16.0(22) AAB의 패키지·버전·targetSdk 36·업로드 인증서·해시를 검증한 과거 증거를 보존했다.
- [ ] Android 0.17.1(24)은 Play Console 별도 작업에서 빌드·서명·트랙 상태를 확인한다.
