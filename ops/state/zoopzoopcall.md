...
## 현재 상태
- 버전: 0.1.3 RC
- 상태: live 0.1.0 / 출시 준비 PR #8 머지·자동배포 대기
- 스택: Vite + React PWA, pnpm, vitest

## 방금 한 일 (최근)
- 2026-07-10: PR #8 — 알림 표시 성공 후에만 발송 완료 기록, 중복 전달 방지, 원본 CI, 실공고 URL을 포함한 Pages 빌드. typecheck·core 44·web 6·build 통과.
...
- [ ] PR #8 검수·머지 후 Pages 최신 main 자동배포와 실공고 8개 표시 확인
