...
- 웹·PWA 운영 버전: 0.9.0.
- Android 코드·서명 후보: 0.9.0 (versionCode 16).
- 상태: live.
- 저장소: `robom-labs/certbom`.
- 운영 배포: https://certbom.vercel.app/.
- 배포 방식: Vercel Git production.
- 운영 main: `8cebe2ba9414717b2162329efcae2565e5aff7fd`.
- PWA 캐시: `certbom-0.9.0-8cebe2b`.
- Google Play Alpha: versionCode 9, `0.8.3`, 테스터 제공 상태.
- 0.9.0 서명 AAB: `versionCode 16`, R8·리소스 축소·16KB 페이지 정렬·4 ABI·대화면 기본 방향을 검증했으며 Play 트랙은 변경하지 않았다.
