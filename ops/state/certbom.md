...
- 운영 main: `dc44ba9a330faff1d5c47b0927348589dbf85aba`.
- PWA 캐시: `certbom-0.8.3-dc44ba9`.
...
- 데이터 원칙: 공식 출처 8곳의 일정 내용 검토 시각과 자동 연결 점검 시각을 분리해 표시하며 확인되지 않은 시험 시각이나 접수일을 추정하지 않는다. Q-Net 공공데이터 운영 키 등록 전에는 API 연결로 표시하지 않는다.
